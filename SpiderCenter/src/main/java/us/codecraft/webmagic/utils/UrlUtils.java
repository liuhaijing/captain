...
public class UrlUtils {
	 ...
	 */
	private static Pattern patternForHrefWithQuote = Pattern.compile("(<a[^<>]*href=)[\"']([^\"'<>]*)[\"']",
			Pattern.CASE_INSENSITIVE);

	/**
	 * disallow blank space without quote
	 */
	private static Pattern patternForHrefWithoutQuote = Pattern.compile("(<a[^<>]*href=)([^\"'<>\\s]+)",
			Pattern.CASE_INSENSITIVE);
	...
	private static Pattern patternForSrcWithQuote = Pattern.compile("(<img[^<>]*src=)[\"']([^\"'<>]*)[\"']",
			Pattern.CASE_INSENSITIVE);

	// private static Pattern patternForSrcWithoutQuote =
